...
class GetStudentsAction extends Action {
    ...
    void checkSpecificAccessControl() throws UnauthorizedAccessException {
        ...
        if (teamName == null) {
            ...
            StudentAttributes student = studentsLogic.getStudentForGoogleId(courseId, userInfo.id);
    ...
    public JsonResult execute() {
        ...
        if (teamName == null && hasCoursePrivilege) {
            ...
            List<StudentAttributes> studentsForCourse = studentsLogic.getStudentsForCourse(courseId);
            ...
            List<StudentAttributes> studentsForTeam = studentsLogic.getStudentsForTeam(teamName, courseId);
