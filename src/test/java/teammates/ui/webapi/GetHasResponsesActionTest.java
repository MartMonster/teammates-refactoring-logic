...
public class GetHasResponsesActionTest extends BaseActionTest<GetHasResponsesAction> {
    ...
    protected void testExecute_asInstructorWithFakeQuestion_shouldFail() {
        ...
        loginAsInstructor(instructor1OfCourse1.getGoogleId());
        assertNull(feedbackQuestionsLogic.getFeedbackQuestion("fake-question-id"));
    ...
    protected void testExecute_asInstructorGetRespondentsInCourse_shouldPass() {
        ...
        assertTrue(feedbackResponsesLogic.hasResponsesForCourse(instructor1OfCourse1.getCourseId()));
        ...
        assertFalse(feedbackResponsesLogic.hasResponsesForCourse(instructor1OfCourse4.getCourseId()));
    ...
    protected void asInstructor_getRespondentsForQuestion_shouldPass() {
        ...
        loginAsInstructor(instructor1OfCourse1.getGoogleId());
        assertTrue(feedbackResponsesLogic.areThereResponsesForQuestion(fQuestion.getFeedbackQuestionId()));
        ...
        List<InstructorAttributes> instructors = instructorsLogic.getInstructorsForCourse(feedbackSessionAttributes.getCourseId());
        ...
        assertFalse(feedbackResponsesLogic.areThereResponsesForQuestion(fQuestion.getFeedbackQuestionId()));
    ...
    protected void testExecute_asInstructorWithQuestionIdAndCourseId_preferQuestionId() {
        ...
        assertFalse(feedbackResponsesLogic.areThereResponsesForQuestion(fQuestion.getFeedbackQuestionId()));
        assertTrue(feedbackResponsesLogic.hasResponsesForCourse(currentInstructor.getCourseId()));
    ...
    protected void testExecute_asStudentWithFakeFeedbackSessionName_shouldFail() {
        ...
        assertNull(feedbackSessionsLogic.getFeedbackSession("fake-session-name", student1InCourse1.getCourse()));
    ...
    protected void testAccessControl() {
        ...
        List<FeedbackSessionAttributes> feedbackSessionAttributesList =
                feedbackSessionsLogic.getFeedbackSessionsForCourse(instructor1OfCourse1.getCourseId());
        List<FeedbackQuestionAttributes> feedbackQuestionAttributesList = feedbackQuestionsLogic.getFeedbackQuestionsForSession(
